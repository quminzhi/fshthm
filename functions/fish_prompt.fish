set __toaster_color_red AF0000
...
set __toaster_color_light_grey BCBCBC
set __toaster_color_white F1F1F1
set __toaster_color_purple AF5FFF
...
function __toaster_prompt_hostname
  set -l host (hostname -s)
  set -l user (whoami)

  if [ "$user" = "root" ]
    __toaster_color_echo $__toaster_color_red $user
	  __toaster_color_echo $__toaster_color_purple '@'$host' '
  else
    __toaster_color_echo $__toaster_color_blue ' '$user
	  __toaster_color_echo $__toaster_color_orange ' [@'$host'] '
  end
end
...
function fish_prompt
  __toaster_color_echo $__toaster_color_blue "(◕‿◕)➜"
  __toaster_prompt_hostname
  __toaster_color_echo $__toaster_color_light_grey (prompt_pwd)
  ...
  if test $uid -eq '0'
    ...
    __toaster_color_echo $__toaster_color_yellow "❯"
    __toaster_color_echo $__toaster_color_light_grey "❯ "
  end
end
